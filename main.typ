...
#align(center)[
  #grid(
    ...
    align(left)[*Student Email:*], align(left)[vu-thuy-trang.nguyen\@stud.uni-bamberg.de],
    align(left)[*Degree Program:*], align(left)[International Information System Management],
...
Established in 2005, Tan Hiep Thanh Joint-Stock Company is a specialized provider of optimized plant nutrition solutions in Vietnam. The company focuses on high-tech agricultural products, such as foliar fertilizers, root-applied nutrients, micro-elements, and probiotics. These products are developed using advanced technology tailored to specific soil characteristics and crop requirements to increase productivity and sustainable income for farmers.
...
While the O2C cycle was functional, it remained highly fragmented because employees often performed identical core tasks through varying methods, personal habits, and individual speeds.
...
I extend sincere gratitude to my supervisor, Ms. Thi Nhan Vu, for her trust and guidance throughout this experience. The insights gained during these 17 weeks provide a robust foundation for my future career in managing complex digital initiatives in a global context.
